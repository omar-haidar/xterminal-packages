...
termux_step_configure () {
	...
	# such as '-Wl,-rpath,/data/data/dev.omar.xterminal/files/usr/lib'
	# and '-I/data/data/dev.omar.xterminal/files/usr/include/qt6/QtCore',
	# but fails to correctly set some other necessary build settings,
	# like 'aarch64-linux-android-clang++' and '-L/data/data/dev.omar.xterminal/files/usr/lib',
